...
const SingleSalonAdmin = () => {
  ...
  const navigate = useNavigate()
   ...
   const postcompany=()=>{
    fetch(`https://good-puce-hummingbird-garb.cyclic.app/salon/update/${id}`,{
        method:"PATCH",
  ...
  return (
    ...
    <br />
    <button className='btn' onClick={addNewCompany} >Update Company</button>
...
export default SingleSalonAdmin