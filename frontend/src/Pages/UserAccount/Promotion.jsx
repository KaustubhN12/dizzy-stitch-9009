      ...
      <Box className="account-Nav" marginBottom="25px">
           <Box width="83%" margin={"auto"}>
             ...
             <Link to="/orders"><Box padding="15px" ><Text >My orders</Text></Box></Link>
                ...
                <Link to="/promotion"><Box padding="15px"borderBottom="2px solid #ef534e"><Text fontSize="sm" color="#ef534e">Promotions</Text></Box></Link>
             </Box>
           </Box>
      </Box>

      <Box width="83%" margin={"auto"}>
        <Text marginLeft="30px" fontSize="23px" fontWeight="thin">My Promos</Text>
      </Box>
