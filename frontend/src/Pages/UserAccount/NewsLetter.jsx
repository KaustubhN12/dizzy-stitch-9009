...
const NewsLetter = () => {
  return (
    ...
    <Box className="account-Nav" marginBottom="25px">
         <Box width="83%" margin={"auto"}>
           ...
           <Link to="/orders"><Box padding="15px" ><Text >My orders</Text></Box></Link>
                ...
                <Link to="/newsletter"><Box padding="15px" borderBottom="2px solid #ef534e"><Text fontSize="sm" color="#ef534e">Newsletters</Text></Box></Link>
    ...
    <Box width="83%" margin={"auto"} >
      <Image marginLeft="250px" src={"https://i.ibb.co/JxcvyYW/Screenshot-2078.png"}/>
    </Box>
