  ...
  return (
    <div style={{ backgroundColor: "#e1e9ec", height: "auto" , paddingBottom:"30px" }}>
      ...
      <Box className="account-Nav" marginBottom="25px">
           <Box width="83%" margin={"auto"}>
             ...
             <Link to="/orders"><Box padding="15px" ><Text >My orders</Text></Box></Link>
                ...
                <Link to="/profile"><Box padding="15px" borderBottom="2px solid #ef534e"><Text fontSize="sm" color="#ef534e">Profile</Text></Box></Link>
      ...
      <Box width="83%" margin={"auto"} textAlign="center">
        <Text marginLeft="30px" fontSize="23px" fontWeight="thin">My Profile</Text>
      </Box>
