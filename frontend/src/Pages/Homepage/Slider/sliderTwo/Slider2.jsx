...
import { Box, Container, Divider, HStack, Img, ScaleFade, Text, VStack } from "@chakra-ui/react";
                ...
                {data && data.map((item) => {
                    return <Container centerContent overflow={"hidden"} maxW={"fit-content"} key={item.title}>
                        <Box height={["300px"]} width={["300px","250px","200px"]} boxShadow={"inset 0px -140px 98px -17px rgba(0,0,0,0.83)"} backgroundImage={`url(${item.image})`} position={'relative'}
                            ...
                            <VStack color={'white'} position={'absolute'} padding={'15px'} bottom={"0"}>
                ...
                {data && data.map((item) => {
                    ...
                    >
                        ...
                        >
                            ...
                            <Text paddingLeft={"10px"} colour={"#a1a1a1"} fontFamily={"sans-serif"} fontWeight={"600"} fontSize={"16px"} >{item.title}</Text>
                            <br />
                            <Text paddingLeft={"10px"} colour={"#a1a1a1"} fontSize={"13px"} fontWeight={"400"} fontFamily={"sans-serif"}>{item.place}</Text>
                            <br />
                            <Text paddingLeft={"10px"} colour={"#a1a1a1"} fontSize={"13px"} fontWeight={"400"} fontFamily={"sans-serif"}>{item.service}</Text>
                            <hr />
