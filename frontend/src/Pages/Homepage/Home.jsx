...
const Home = () => {
  ...
  return (
    <Box>
      ...
      <Box width={"100%"} backgroundColor={"#f1f1f1"}>
      ...
      <Box width={"92%"} margin="auto">
        <Text fontSize={"24"} fontWeight={"700"} fontFamily="sans-serif">
          Top Brands
        </Text>
