...
const Health = () => {
  ...
  const page_info =
    "NEARBUY > DEALS IN NEW DELHI > ALL HEALTH DEALS IN NEW DELHI";
  let Restaurants = 0;
  ...
  for (let i = 0; i < health.length; i++) {
    Restaurants++;
    if (dynamicFilter[health[i].place] == undefined) {
      dynamicFilter[health[i].place] = 1;
      filterArray.push(health[i].place);
    } else {
