...
import {
  ...
  GET_HEALTH_REQUEST,
  GET_PREMIUM_RESTAURANT_REQUEST,
  GET_SALON_REQUEST,
  PRODUCT_FAILURE,
  PRODUCT_REQUEST,
} from "./ActionType";
...
export const getPremiumRestaurant = (param) => (dispatch) => {
  ...
  axios
    .get("https://good-puce-hummingbird-garb.cyclic.app/restaurant/get", param)
    .then((res) => {
...
export const getGiftCards = (param) => (dispatch) => {
  dispatch(productRequst());
  axios
    .get("https://good-puce-hummingbird-garb.cyclic.app/gift/get", param)
    .then((res) => {
...
export const getHealth = (param) => (dispatch) => {
  dispatch(productRequst());
  axios
    .get("https://good-puce-hummingbird-garb.cyclic.app/health/get", param)
    .then((res) => {
...
export const getSalon = (param) => (dispatch) => {
  dispatch(productRequst());
  axios
    .get("https://good-puce-hummingbird-garb.cyclic.app/salon/get", param)
    .then((res) => {
