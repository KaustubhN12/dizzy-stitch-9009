...
const SalonAdmin = () => {
  ...
  const get=()=>{
    fetch("https://good-puce-hummingbird-garb.cyclic.app/salon/get",{
        headers:{
   ...
   const postcompany=()=>{
    fetch(`https://good-puce-hummingbird-garb.cyclic.app/salon/add`,{
        method:"POST",
   ...
   const delitem=(id)=>{
    fetch(`https://good-puce-hummingbird-garb.cyclic.app/salon/delete/${id}`,{
        method:"DELETE",
        headers:{
            "Content-type":"application/json"
        }
  ...
  return (
    ...
    <div  className='container' id="salon" >

    <div className='maindiv'>
    <h1 className='heading' >Salon Admin Section</h1>
