...
const GiftAdmin = () => {
  ...
  const get=()=>{
    fetch("https://good-puce-hummingbird-garb.cyclic.app/gift/get",{
        headers:{
   ...
   const postcompany=()=>{
    fetch(`https://good-puce-hummingbird-garb.cyclic.app/gift/add`,{
        method:"POST",
   ...
   const delitem=(id)=>{
    fetch(`https://good-puce-hummingbird-garb.cyclic.app/gift/delete/${id}`,{
        method:"DELETE",
        headers:{
            "Content-type":"application/json"
        }
  ...
  return (
    ...
    <div  className='container' id="gift" >

    <div className='maindiv'>
    <h1 className='heading' >Gift Admin Section</h1>
