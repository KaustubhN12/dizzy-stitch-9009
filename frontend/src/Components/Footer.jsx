    ...
    <div>
        ...
        >
          ...
          >
            <Text
              ...
              fontWeight={"700"}
              fontSize={"16px"}
              marginRight={"40px"}>Follow Us</Text>
      ...
      >
        <Flex>
          <VStack h={"200px"} width={"25%"} align={"start"}>
            ...
            <Text color={"#FFFFFF"}
              fontFamily={"sans-serif"}
              fontSize={"13px"}
              fontWeight={"400"}>Blog</Text>
            <Text color={"#FFFFFF"}
              fontFamily={"sans-serif"}
              fontSize={"13px"}
              fontWeight={"400"}>Policy</Text>
            <Text
              color={"#FFFFFF"}
              fontFamily={"sans-serif"}
              fontSize={"13px"}
              fontWeight={"400"}>Universal Fine Print</Text>
          </VStack>
          <VStack h={"200px"}  width={"25%"} align={"start"}>
            <Text
              color={"#FFFFFF"}
          ...
          <VStack h={"200px"}  width={"50%"}>
            ...
            <HStack >
              <Stack w={"30%"} >
                <Img border={"1px solid white"} borderRadius={"4px"} w={"60%"} src="https://www.barcodelookup.com/assets/images/google-play.png" alt="" />
                <Text
                  color={"#FFFFFF"}
                  fontFamily={"sans-serif"}
                  fontSize={"13px"}
              ...
              <Stack w={"30%"} >
                <Img border={"1px solid white"} borderRadius={"4px"} w={"60%"} src="https://www.barcodelookup.com/assets/images/app-store.png" alt="" />
                <Text
                  color={"#FFFFFF"}
                  fontFamily={"sans-serif"}
                  fontSize={"13px"}
            ...
            <Text
              ...
              alignSelf={"start"}
              // paddingLeft={"32px"}
            >Customer Care: +91-7303390416 - 11 AM to 8 PM (MON - SUN)</Text>
          </VStack>
        </Flex>
        ...
        <Text
          ...
          fontSize={"13px"}
          fontWeight={"400"}
        >Copyright © nearbuy.com India Private Limited. All rights reserved.</Text>
        <Text
          color={"#999999"}
          fontFamily={"sans-serif"}
          fontSize={"13px"}
