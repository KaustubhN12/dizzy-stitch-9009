    ...
    <Box width={"100%"} borderBottom={"1px solid RGB(226 226 226)"}>
      ...
      >
        ...
        <GridItem bg="white" area={"logo"}>
          <Link to={"/"}>
            <Box pl={["0px", "0px", "140px"]} py={"5px"} width={"100%"}>
              <Img
                width={["150px", "150px", "250px"]}
                height={["45px", "45px", "55px"]}
                src={"https://i.ibb.co/nQRNKjQ/nearBuy.png"}
              />
            </Box>
          </Link>
        </GridItem>
        ...
        >
          <HStack gap={"0"} width={["100%"]}>
            ...
            />
            <Button colorScheme="red" color={"white"} borderRadius={"2"}>
              Search
            </Button>
          </HStack>
        </GridItem>

        <GridItem bg="#f1f1f1" area={"blank"}></GridItem>

        <GridItem bg="white" area={"blank2"}></GridItem>
      </Grid>
    </Box>
  );
};
